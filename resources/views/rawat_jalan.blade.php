<x-app-layout>
    <div class="p-4 sm:ml-64 lg:p-0 ">
                    ...
                    <div class="p-6">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex flex-col text-center">
                                <span class="text-md font-semibold text-blue-600">Kamis</span>
                                <span class="text-lg font-bold text-blue-700">18 September 2025</span>
                            </div>
                            <!-- Tombol Ke Kanan -->
                            <button class="px-2 py-1 bg-white rounded hover:bg-blue-100 text-blue-500 border">
                                &#62;
        ...
        <div class="w-full h-full flex items-center justify-center mt-10 xl:flex xl:flex-col xl:w-full xl:px-4">
            ...
            <button class="bg-blue-700 px-2 py-4 text-white rounded-md hover:bg-blue-800 font-semibold text-lg">+ TAMBAH
                DATA TENAGA
                MEDIS</button>
        </div>
    </div>
    ...
    <div class="relative">
        <div class="absolute bottom-0 right-0 mr-10">
            <button class="bg-blue-700 flex items-center px-4 py-2 rounded-md">
